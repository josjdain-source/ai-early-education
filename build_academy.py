...
이 교실은 <b>AI 사용법 강의가 아닙니다.</b> 아이가 AI에게 말하고, 이상한 답을 찾고, 다시 묻는 연습을 <b>부모와 함께 4주 동안 해보는 작은 실습 과정</b>입니다.</div></div></section>

<section class="block"><h2 class="sec-title" style="font-size:20px">4주 뒤, 아이의 말이 달라집니다</h2>
<p class="sec-desc" style="text-align:left">부모는 'AI로 만든 멋진 작품'보다, <b>아이가 생각하며 말하는 모습</b>에 마음이 움직입니다.</p>
<div class="grid" style="grid-template-columns:1fr 1fr;gap:14px">
<div class="card" style="border-left:5px solid #c4b59a;background:#faf7f2"><div style="font-size:12px;font-weight:800;color:#9b8a6e">BEFORE · 처음</div>
<p style="font-size:15px;font-weight:700;margin:8px 0 0;color:#7a6f5f">"그림 그려줘."</p>
<p style="font-size:12.5px;color:var(--muted);margin:6px 0 0">한 번 말하고, 이상해도 그냥 넘어가요.</p></div>
<div class="card" style="border-left:5px solid #E0684A;background:#fffaf5"><div style="font-size:12px;font-weight:800;color:#B44A31">AFTER · 4주 뒤</div>
<p style="font-size:15px;font-weight:700;margin:8px 0 0;color:#2B3A55">"파란 모자를 쓴 고양이로 다시 그려줘. 아까는 모자가 빠졌어."</p>
<p style="font-size:12.5px;color:var(--muted);margin:6px 0 0">이상한 곳을 찾고, 조건을 붙여 다시 말해요.</p></div>
</div>
<div class="grid" style="grid-template-columns:1fr 1fr;gap:14px;margin-top:12px">
<div class="card" style="border-left:5px solid #c4b59a;background:#faf7f2"><div style="font-size:12px;font-weight:800;color:#9b8a6e">BEFORE</div>
<p style="font-size:15px;font-weight:700;margin:8px 0 0;color:#7a6f5f">"AI가 그렇대."</p></div>
<div class="card" style="border-left:5px solid #E0684A;background:#fffaf5"><div style="font-size:12px;font-weight:800;color:#B44A31">AFTER</div>
<p style="font-size:15px;font-weight:700;margin:8px 0 0;color:#2B3A55">"이거 진짜야? 어디서 나온 거야?"</p></div>
</div></section>
