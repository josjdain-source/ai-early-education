...
# 5) 업로드 (채널 가드=아이와 AI교실, 항상 private)
python youtube/upload_to_aiclassroom.py --id china-ai-longform
python youtube/upload_to_aiclassroom.py --id china-short-s1   # s2,s3
